...
class MealModel extends Equatable {
  ...
  List<String> get ingredientList => [
        ...
        strIngredient20,
          ...
          // whereType<String>() filters out any null values automatically
          .whereType<String>()
          // Optionally filter out empty strings (or strings with only whitespace)
          .where((ingredient) => ingredient.trim().isNotEmpty)
          .toList();

  List<String> get measureList => [
        strMeasure1,
        strMeasure2,
        strMeasure3,
        strMeasure4,
